...
def find_best_param_ga_mutation_prob(seed, problem):
    ...
    ga_parameter_curve(mutation_prob_String, fitness_list, "mutation_prob", 0.4, "FP")
...
def find_best_param_sa_decay(seed, problem):
    ...
    sa_parameter_curve(init_temp_String, fitness_list, "sa_dacay", 0.4, "FP")
...
def find_best_param_mimic_keep_cpt(seed, problem):
    ...
    fitness_list = []
    iterations = [1, 500, 1000, 1250, 1500, 1750, 2000]
    score = []
    ...
    sa_parameter_curve(keep_cpt_String, fitness_list, "keep_pct", 0.4, "FP")
